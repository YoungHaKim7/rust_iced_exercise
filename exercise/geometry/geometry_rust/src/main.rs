...
mod rainbow {
    ...
    use iced_native::{layout, Element, Layout, Length, Point, Rectangle, Size, Vector, Widget};
...
use iced::{
    scrollable, Alignment, Column, Container, Element, Length, Sandbox, Scrollable, Settings, Text,
};
use rainbow::Rainbow;
